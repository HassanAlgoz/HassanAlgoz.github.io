...
وأعني بالتفاصيل ما تحتويه الدالة من خطوات، والوصف هو أوَّل سطرٍ في هذا المثال:

```go
func minAndMax(A []int) (int, int) {
    min := A[0]
    max := A[0]
    for i := 1; i < len(A); i++ {
        if A[i] < min {
...
```
وفي هذا المثال: نرى السطرين الأوَّليْن يصفان بلغة الخطاب عمل هذا الإجراء، وهذا ما يُعرف بالتوثيق.
...
فإذا قرأ المستخدم الوصفين (معرّف الدالة + التوثيق) عرف ما يأخذ الإجراء وما يُخرج، فلا يعطيه ما لا يقبل ولا يتوقَّع منه ما لا يضمن. وهو بذلك عندما يبني عليه، يبني على إنشاءٍ صحيح.
...
- نعاود العملية مرة أخرى بعد فترة زمنية معيَّنة
- نستخدم بديلاً
- نستشير المستخدم
- نوقف البرنامج
...
## إيصال رسالة الخطأ
وأبسط صور ذلك أن يكتب رسالة الخطأ كما هي للمستخدم ليراها وحسب، وقد يُخيِّر البرنامج المستخدمَ؛ فيختارَ فيسير البرنامجُ بناءً على اختياره.

لكن الخطأ قد لا يعني المستخدمَ، وإنما يعني المطوّر أو مدير النظام الذي يشتغل فيه البرنامج، فحينها يستأذن البرنامجُ المستخدم في إرسال رسالة الخطأ للمعني به. ولا بد في هذه الرسالة أن تكون دالَّة قدر الإمكان على سبب الخطأ ومكانه وحال البرنامج حينه، لأن ذلك يُسهِّلُ معالجته،

وقد يكون للبرنامج سجلٌّ (log) يحوي معلوماتٍ تفيدُ في التدقيق لاحقاً إذا ما حصل خطأ.

## إهمال الخطأ المُبرمَج
الخطأ معلومة أقلُّ ما تفيده عدم تمام الإجراء المطلوب، وبالتالي فإن إهمال هذه المعلومة غلطٌ في إنشاء البرنامج، وما أكثر ما يُهمَل، فيتسبب ذلك في عُسْرِ فهم مكمن الخطأ إذا تراكم الإهمال واتسع أثره ولم يقترن ظهور الخطأ بأصله.

وإن من أسباب هشاشة البرمجيات المكتوبة بلغاتٍ مثل: PHP و Python و Javascript هو أن الأصل فيها الإهمال؛ فاللغة لا تنبهك على مسارات الخطأ الممكنة. وهذا مما لا يُمكن تداركه لأنه مبنيٌّ في أساس اللغة.

# إصلاح الغلط الإنشائي
وإني أحرِّص عليك أن لا تسوِّف معالجة ما تراه من علامات على وجود الأغلاط الإنشائية، لأنَّ ذلك يُنسى مع طول زمن المشروع، كما أنه بتراكمه يصعب معالجته لا كما لو أُصلح في حينه، وإن تُرك فإنه يكون سبباً لأغلاط أخرى، وتستمر المعاناة.

وإن كنت لا بُدَّ مؤجِّلاً؛ فسجّل الغلط وتاريخه وحال المشروع حينه حتى لا يُنسى وحتى لا يخفى على من يأتي بعدك ممن لم يشهده معك.
